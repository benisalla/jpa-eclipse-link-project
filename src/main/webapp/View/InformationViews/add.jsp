			...
			<div class="card container" style="width: 44rem; margin:3rem auto;">
				...
				<form action="add" method="post">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-10">
				      <input value="" type="text" name="name" class="form-control" id="name" placeholder="your name">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-10">
				      <input value="" type="email" name="email" class="form-control" id="email" placeholder="your email">
				    </div>
				  </div>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-10">
				      <input value="" name="profession" type="text" class="form-control" id="profession" placeholder="your profession">
				    </div>
				  </div>
